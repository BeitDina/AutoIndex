...
N("l","portal/?page=2","")+
 N("h",0,"SITE")+
N("l","sitemap.html","SiteMap")+
N("l","contact.html","Contact")+
N("l","guestb.html#&from=0&to=100","GuestBook")+
N("l","search.html","Search")+
 N("h",0,"INFO-NEWS")+
N("l","download.html","Download")+
N("l","trivory.html","TrivOry")+
N("l","wangscript.html","WangScript")+
N("l","projects.html","Projects")+
N("l","news/index.html","New!")+
N("l","news/index.htm","Nou!")+
