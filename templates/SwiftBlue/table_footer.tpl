 	<tr>
		  <th class="table1 autoindex_th stat-block online-list">
		  ...
		  <th class="table1 autoindex_th stat-block online-list responsive-hide">
		   &nbsp;
		  </th>
		  {if:description_file}
		  <th class="table1 autoindex_th stat-block online-list responsive-hide">
		...
		{if:archive}
		<div class="autoindex_small stat-block online-list" style="text-align: left;">
		 ...
		 <tr style="vertical-align: top;">
		  ...
		  <td>
		   ...
		   <td class="autoindex_td search_box" style="padding: 8px;">
			{if:icon_path}
			<a title="{words:search}"><i class="icon ion-ios-search fa-fw" style="aria-hidden=true"></i></a>	
		  ...
		  <td>
		   ...
		   <td class="autoindex_td login_box" style="padding: 8px;">
			{if:icon_path}
			<a title="{words:login}"><i class="icon ion-ios-log-in fa-fw" style="aria-hidden=true"></i><i class="icon ion-ios-log-out fa-fw" style="aria-hidden=true"></i></a>
